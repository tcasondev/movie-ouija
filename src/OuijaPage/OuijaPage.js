...
export default class OuijaPage extends Component {
  ...
  getRandomMovie() {
    ...
    let filterMovieList = this.state.movieList.filter(
      (filterMovie) => filterMovie.genre === genre
    );
    let filterMovie =
      filterMovieList[Math.floor(Math.random() * filterMovieList.length)];
      ...
      return (
        <div className="OuijaArea">
          ...
          <div className="ouijaForm">
            <p>
              If you'd like you may ask the spirits for a specific genre, though
              this is not required
            </p>
            <p>
              If you're new here, this app selects solely from the list of
              movies that you provide. Feel free to pop over to 'My List' and
              add away!
            </p>
