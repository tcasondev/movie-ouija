  ...
  render() {
    return (
      <div className="aboutPage">
        <h1>Landing Page</h1>
        <p>
          Call on the spirits to determine your fate. What shall you watch
          tonight?
        </p>
        <p>
          If you would like to preview the app without creating an account, feel
          free to login with the following credentials:
        </p>
